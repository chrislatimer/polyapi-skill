...
```bash
npx skills add chrislatimer/polyapi-skill --skill polyapi-platform --agent claude-code
```
...
```bash
npx github:chrislatimer/polyapi-skill
```
...
```bash
git clone https://github.com/chrislatimer/polyapi-skill.git
```
